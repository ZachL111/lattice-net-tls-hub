"""Regression checks for the lattice-net-tls-hub casebook."""
...
from casebook.harness import assert_expected, lattice_net_tls_hub_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(lattice_net_tls_hub_summary(), assert_expected())
