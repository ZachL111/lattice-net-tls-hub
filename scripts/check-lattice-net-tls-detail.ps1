...
$repo = "lattice-net-tls-hub"
$language = "TypeScript"
$category = "Networking"

foreach ($path in @("metadata/domain-review.json", "config/review-profile.json", "fixtures/domain_review.csv", "docs/field-notes.md", "docs/review-journal.md", "examples/lattice-net-tls-walkthrough.md")) {
